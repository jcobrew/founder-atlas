// Canonical 0rbital taxonomy.
//
// This module is the single source of truth for canonical ID sets used to
// describe co-living founder programs. It exists alongside — not instead of —
...
//
// Active scope is intentionally narrow: founder residencies and hacker/founder
// houses where builders live together for a fixed term. Non-residential startup
// support categories are kept only as legacy representable IDs with `mvp:false`
// so old data can normalize without presenting them as active MVP program types.
...
export interface TaxonomyEntry<Id extends string = string> {
  ...
  label: string;
  /**
   * Is this value in scope for the current MVP? For `programType` this marks
   * only active co-living categories; for the other dimensions it marks values
...
// ---------------------------------------------------------------------------
// 1. programType — co-living-first taxonomy.
//    Active MVP categories (mvp:true): founder residencies and hacker/founder
//    houses. Retired/non-residential categories remain representable only for
//    backward-compatible normalization and are explicitly not active MVP types.
// ---------------------------------------------------------------------------
export const PROGRAM_TYPES = [
  ...
  },
  {
    ...
    mvp: false,
    description:
      "Visa, relocation, or soft-landing program that lets a founder build in a country.",
  },
  {
  ...
  },
  {
    ...
    mvp: false,
    description:
      "Builds companies in-house and recruits founders into pre-formed ideas.",
  },
  {
    ...
    mvp: false,
    description:
      "Run by or with a large company; access to customers/pilots, often no equity (Plug and Play, Wayra).",
  },
  {
    ...
    mvp: false,
    description:
      "Campus-affiliated accelerator/incubator for students, alumni, or researchers (StartX, Berkeley SkyDeck).",
  },
  {
    id: "tech-transfer",
    ...
    mvp: false,
    description:
      "University or lab office that commercializes research into spin-out companies.",
  },
  {
    ...
    mvp: false,
    description:
      "Provides wet-lab or hard-tech facilities plus capital for science startups (IndieBio, HAX).",
  },
  {
    id: "startup-campus",
    ...
    mvp: false,
    description:
      "A building or hub hosting many programs and companies at once (Station F, Norrsken House).",
  },
  {
    id: "venture-debt",
    ...
    mvp: false,
    description:
      "Debt-based financing for startups instead of equity investment.",
  },
  {
    id: "pop-up-village",
    ...
    mvp: false,
    description:
      "A temporary town/community of builders that exists for weeks (Edge Esmeralda).",
  },
  {
    ...
    mvp: false,
    description:
      "Region- or community-specific support orgs, networks, or hubs that do not fit a cleaner category.",
  },
  {
    id: "other",
    ...
    mvp: false,
    description:
      "Fallback for programs whose legacy type does not map to a known canonical category.",
  },
...
export const SUPPORT_MODES = [
  {
    ...
    mvp: true,
    description: "Provides cash, an investment cheque, or a stipend.",
  },
  {
    id: "housing",
    label: "Housing",
    mvp: true,
    description: "Provides a place to live for the program duration.",
  },
  {
    id: "workspace",
    label: "Workspace",
    mvp: true,
    description: "Provides desks / office / coworking space.",
  },
  {
    id: "mentorship",
    label: "Mentorship",
    mvp: true,
    description: "Structured mentorship, coaching, or advisors.",
  },
  {
    id: "investor-access",
    label: "Investor access",
    mvp: true,
    description: "Introductions to investors / fundraising help.",
  },
  {
    id: "demo-day",
    label: "Demo day",
    mvp: true,
    description: "A pitch / demo day to investors at the end.",
  },
  {
    id: "visa-support",
    label: "Visa / relocation support",
    mvp: true,
    description: "Helps with visas, relocation, or soft-landing.",
  },
  {
    id: "community",
    label: "Community / peers",
    mvp: true,
    description: "A community of peers, builders, or alumni.",
  },
  {
  ...
  {
    id: "customers",
    label: "Customers / pilots",
    mvp: false,
    description: "Access to customers, pilots, or distribution.",
  },
  {
    id: "structure",
    label: "Structure / focus",
    mvp: true,
    description: "Imposed structure, deadlines, or full-time focus.",
  },
  {
    id: "compute-credits",
    label: "Compute / cloud credits",
    mvp: false,
    description: "Free GPU / cloud / model-API credits.",
  },
  {
    id: "lab-access",
    label: "Lab / hardware access",
    mvp: false,
    description: "Wet-lab, prototyping, or hardware facilities.",
  },
  {
    id: "legal-admin",
    label: "Legal / admin support",
    mvp: false,
    description: "Incorporation, legal, or back-office help.",
  },
] as const satisfies ReadonlyArray<TaxonomyEntry>;
...
export const FOUNDER_STAGES = [
  {
    ...
    label: "Pre-idea",
    mvp: true,
    description: "No idea yet; exploring whether to start.",
  },
  {
    id: "idea",
    label: "Idea",
    mvp: true,
    description: "Has an idea, no product yet.",
  },
  {
    id: "pre-product",
    label: "Pre-product",
    mvp: true,
    description: "Validating; pre-build.",
  },
  {
    id: "mvp",
    label: "MVP",
    mvp: true,
    description: "Has an early product / MVP.",
  },
  {
    id: "pre-seed",
    label: "Pre-seed",
    mvp: true,
    description: "Raising or about to raise pre-seed.",
  },
  ...
  },
  {
    ...
    mvp: true,
    description: "Has founded before.",
  },
  {
    id: "student",
    label: "Student",
    mvp: true,
    description: "Currently a student.",
  },
  {
    id: "researcher",
    label: "Researcher",
    mvp: false,
    description: "Academic / research background.",
  },
  {
    id: "unknown",
    label: "Unknown",
    mvp: true,
    description: "Stage not specified.",
  },
] as const satisfies ReadonlyArray<TaxonomyEntry>;
...
export const INTAKE_METHODS = [
  {
    ...
    label: "Rolling",
    mvp: true,
    description: "Accepts applications continuously / always open.",
  },
  {
    id: "cohort-application",
    label: "Cohort application",
    mvp: true,
    description: "Apply to a specific dated cohort.",
  },
  {
    id: "open-call",
    label: "Open call",
    mvp: true,
    description: "A specific open call / round you respond to.",
  },
  {
    id: "invitation",
    label: "Invitation / referral",
    mvp: true,
    description: "By invitation, nomination, or referral only.",
  },
  {
    id: "membership",
    label: "Membership / pay-to-join",
    mvp: false,
    description: "Join by paying membership or rent.",
  },
  {
    id: "unknown",
    label: "Unknown",
    mvp: true,
    description: "Intake method not specified.",
  },
] as const satisfies ReadonlyArray<TaxonomyEntry>;
...
export const INTAKE_FREQUENCIES = [
  {
    ...
    label: "Rolling",
    mvp: true,
    description: "Always open / continuous intake.",
  },
  {
    id: "annual",
    label: "Annual",
    mvp: true,
    description: "About once a year.",
  },
  {
    id: "biannual",
    label: "Biannual",
  ...
  },
  {
    ...
    label: "Quarterly",
    mvp: true,
    description: "About four times a year.",
  },
  {
    id: "ad-hoc",
    label: "Ad-hoc",
    mvp: true,
    description: "Irregular / as announced.",
  },
  {
    id: "unknown",
    label: "Unknown",
    mvp: true,
    description: "Frequency not specified.",
  },
] as const satisfies ReadonlyArray<TaxonomyEntry>;
...
export const COST_FUNDING_MODELS = [
  {
    ...
    mvp: true,
    description: "Gives cash and takes equity (typically via SAFE).",
  },
  {
  ...
  },
  {
    ...
    label: "Stipend",
    mvp: true,
    description: "Pays a living stipend rather than an investment cheque.",
  },
  {
    id: "fee",
    label: "Fee / paid",
    mvp: true,
    description: "You pay a fee, tuition, or rent to participate.",
  },
  {
    id: "free",
    label: "Free",
    mvp: true,
    description: "No fee and no equity — access-based.",
  },
  {
    id: "venture-debt",
    label: "Venture debt",
    mvp: false,
    description: "Debt-based financing.",
  },
  {
    id: "mixed",
    label: "Mixed",
    mvp: true,
    description: "Combination of the above (e.g. equity + optional fee).",
  },
  {
    id: "unknown",
    label: "Unknown",
    mvp: true,
    description: "Cost / funding model not specified.",
  },
] as const satisfies ReadonlyArray<TaxonomyEntry>;
...
/** Only the MVP-scoped co-living program-type IDs. */
export const MVP_PROGRAM_TYPE_IDS: ProgramTypeId[] = PROGRAM_TYPES.filter(
  (e) => e.mvp,
).map((e) => e.id);
...
export function labelFor(dimension: TaxonomyDimension, id: string): string {
  const entry = (TAXONOMY[dimension] as ReadonlyArray<TaxonomyEntry>).find(
    (e) => e.id === id,
  );
